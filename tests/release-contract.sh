...
cat LICENSE client/vendor/LICENSE client/vendor/examples/jsm/libs/fflate-LICENSE > "$root/expected-licenses"
cmp "$root/expected-licenses" "$root/unpacked/LICENSE" || fail 'vendored licenses differ from package'
